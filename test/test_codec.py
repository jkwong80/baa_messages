...
class TestCodec(unittest.TestCase):
    ctx = BAAContext(parent_id='Seth S', timestamp_us=time.time(), location=[0.0, 0.0], sensor_id=123, sensor_unit_id=1)
    x = GPSReading(latitude=10, longitude=20)
    ...
    def test_simple_json_encoding(self):
